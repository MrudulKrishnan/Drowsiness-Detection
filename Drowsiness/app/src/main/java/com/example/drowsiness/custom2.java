...
class custom2 extends BaseAdapter {
...
//    ArrayList<String> b;
    ...
    public custom2(Context applicationContext, ArrayList<String> a, ArrayList<String> c, ArrayList<String> d ) {
...
//        this.e=e;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_cutsom2,null);
